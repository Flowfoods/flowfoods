...
const PACOTES = [
  ...
  },
  {
    ...
    numero: '02',
    titulo: 'Consultoria',
    subtitulo: '90 dias de transformação',
    descricao:
      'O pacote completo para restaurantes que querem crescer de forma estruturada. iFood otimizado, equipe treinada, financeiro no controle — em 90 dias.',
    inclui: [
      'Diagnóstico completo',
      'Otimização iFood (10–15 dias)',
      'Treinamento de equipe (30 dias)',
